...
const HALLAZGOS = [
  ...
  {tipo:'hipotesis', t:'Carlini o Carlino: una letra que mueve la búsqueda mil kilómetros',
   b:'La familia recuerda que en algún momento el apellido fue CARLINO, y ese recuerdo vale más que cualquier archivo. CARLINI y CARLINO no son variantes del mismo lugar: son de lugares opuestos. Carlini tiene 626 familias en Emilia-Romagna, 616 en el Lazio, 488 en Liguria — y SIETE en toda Sicilia. Carlino tiene 563 en Sicilia, su primera región, 379 en Puglia, 222 en Campania, y casi ninguna en el centro-norte. Un investigador de la familia buscó tres meses en el Archivio di Stato di Catania sin encontrar nada; si la memoria es correcta, buscó la letra equivocada, no la provincia. Y además cierra sola una pregunta que estaba abierta: cómo un Carlini del centro de Italia terminó casándose con una Fichera de Acireale en Mar del Plata. Si eran Carlino, no hay nada que explicar: eran dos familias sicilianas de la misma colectividad.'},
